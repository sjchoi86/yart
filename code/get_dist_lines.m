...
%
function [dist,varargout] = get_dist_lines(point1s,point1e,point2s,point2e)

point1s = reshape(point1s,1,[]);
point1e = reshape(point1e,1,[]);
point2s = reshape(point2s,1,[]);
point2e = reshape(point2e,1,[]);

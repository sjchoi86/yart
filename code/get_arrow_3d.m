function [fv,propertyNames,propertyValues] = get_arrow_3d(p1,p2,varargin)
...
tipAngle = 42.5/180*pi;
tipLength = tipWidth/tan(tipAngle/2);
ppsc = 10;  % (points per small circle) 50
ppbc = 50; % (points per big circle) 250
